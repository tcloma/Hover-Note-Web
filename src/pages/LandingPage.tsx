...
const LandingPage = ({ dirName, setDirName, hasInitDir }: Props) => {
   ...
   return (
      <Flex h='100vh' minW='60vw' justify='center' align='center' bg='gray.800' color='whiteAlpha.900'>
            ...
            {showDir ?
               <FormControl>
                  <Input
                     ...
                     mb='1em'
                  />
                  <Button colorScheme='purple' variant='solid' onClick={handleBrowseClick} w='48%' h='8vh' mr='4%'>
                     Browse
                  </Button>
                  <Button onClick={handleSubmit} variant='outline' colorScheme='purple' w='48%' h='8vh'>
                     Confirm
                  </Button>
               </FormControl>
               :
               <Text color='gray.400' onClick={handleContinueClick} fontSize='xl'> Click to continue </Text>
            }
         </Flex>
      </Flex>
   )
